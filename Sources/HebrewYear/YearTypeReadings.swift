...
struct YearTypeReadings {
  ...
  static func reading(for type: HebrewYear.YearType, month: HebrewYear.Month, day: Int, location: Location = .diaspora) -> Reading? {
    locationReadings(for: type, location: location)[month.rawValue - 1][day]
  }
  
  static func readings(for type: HebrewYear.YearType, location: Location = .diaspora) -> [(HebrewYear.Month, Int, Reading)] {
    locationReadings(for: type, location: location).enumerated().flatMap { monthIndex, monthlyReadings in
  ...
  private static func locationReadings(for type: HebrewYear.YearType, location: Location) -> Readings {
    switch location {
      case .diaspora: return diasporaReadings(for: type)
      case .israel: return israelReadings(for: type)
    }
  }
  
  private static func diasporaReadings(for type: HebrewYear.YearType) -> Readings {
    switch type {
      case .בחג: return [
      ...
      case .השא: return [
        ...
        [4: vayigash, 11: vayechi, 18: shemot, 25: vaera],
  ...
  private static func israelReadings(for type: HebrewYear.YearType) -> Readings {
    switch type {
      case .בחג: return [
        [6: vayelech, 13: haazinu, 22: vezotHaberachah, 27: bereshit],
        [4: noach, 11: lechLecha, 18: vayera, 25: chayeiSarah],
        [3: toldot, 10: vayetze, 17: vayishlach, 24: vayeshev],
        [2: miketz, 9: vayigash, 16: vayechi, 23: shemot],
        [1: vaera, 8: bo, 15: beshalach, 22: yitro, 29: mishpatim],
      ...
      case .בשה: return [
        ...
        [1: tazriaMetzora, 8: achareiMotKedoshim, 15: emor,
         22: beharBechukotai, 29: bamidbar],
        [7: naso, 14: behaalotecha, 21: shelachLecha, 28: korach],
        [5: chukat, 12: balak, 19: pinchas, 26: matotMasei],
        [4: devarim, 11: vaetchanan, 18: ekev, 25: reeh],
        [2: shoftim, 9: kiTetze, 16: kiTavo, 23: nitzavimVayelech]
      ]
      case .גכה: return [
        [5: vayelech, 12: haazinu, 22: vezotHaberachah, 26: bereshit],
        [3: noach, 10: lechLecha, 17: vayera, 24: chayeiSarah],
        [2: toldot, 9: vayetze, 16: vayishlach, 23: vayeshev, 30: miketz],
        [7: vayigash, 14: vayechi, 21: shemot, 28: vaera],
        [6: bo, 13: beshalach, 20: yitro, 27: mishpatim],
      ...
      case .הכז: return [
        [3: haazinu, 22: vezotHaberachah, 24: bereshit],
        [1: noach, 8: lechLecha, 15: vayera, 22: chayeiSarah, 29: toldot],
        [7: vayetze, 14: vayishlach, 21: vayeshev, 28: miketz],
        [5: vayigash, 12: vayechi, 19: shemot, 26: vaera],
        [4: bo, 11: beshalach, 18: yitro, 25: mishpatim],
        [:],
        [2: terumah, 9: tetzaveh, 16: kiTisa, 23: vayakhelPekudei],
        [1: vayikra, 8: tzav, 22: shemini, 29: tazriaMetzora],
        [6: achareiMotKedoshim, 13: emor, 20: behar, 27: bechukotai],
        [5: bamidbar, 12: naso, 19: behaalotecha, 26: shelachLecha],
        [3: korach, 10: chukat, 17: balak, 24: pinchas],
        [2: matotMasei, 9: devarim, 16: vaetchanan, 23: ekev, 30: reeh],
        [7: shoftim, 14: kiTetze, 21: kiTavo, 28: nitzavim]
      ...
      case .זחא: return [
        [8: haazinu, 22: vezotHaberachah, 29: bereshit],
        [6: noach, 13: lechLecha, 20: vayera, 27: chayeiSarah],
        [5: toldot, 12: vayetze, 19: vayishlach, 26: vayeshev],
        [4: miketz, 11: vayigash, 18: vayechi, 25: shemot],
        [3: vaera, 10: bo, 17: beshalach, 24: yitro],
      ...
      case .בשז: return [
        ...
        [4: terumah, 11: tetzaveh, 18: kiTisa, 25: vayakhel],
        [2: pekudei, 9: vayikra, 16: tzav, 23: shemini],
        [1: tazria, 8: metzora, 22: achareiMot, 29: kedoshim],
        [6: emor, 13: behar, 20: bechukotai, 27:  bamidbar],
        [5: naso, 12: behaalotecha, 19: shelachLecha, 26: korach],
        [3: chukat, 10: balak, 17: pinchas, 24: matot],
        [2: masei, 9: devarim, 16: vaetchanan, 23: ekev, 30: reeh],
        [7: shoftim, 14: kiTetze, 21: kiTavo, 28: nitzavim]
      ]
      case .גכז: return [
        [5: vayelech, 12: haazinu, 22: vezotHaberachah, 26: bereshit],
